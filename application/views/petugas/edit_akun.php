...
<h1>Edit Akun</h1><br />
<form method="post" name="form" onSubmit="return validasi()" action="<?php echo base_url()?>index.php/petugas/changeAkun"/>
...
<tr>
	<td>YM Username</td>
	<td>:</td>
	<td><input type="text" name="ym" value="<?php echo $petugas->ym_user;?>"/></td>
</tr>
<tr>
	<td>Password Lama</td>
	<td>:</td>
